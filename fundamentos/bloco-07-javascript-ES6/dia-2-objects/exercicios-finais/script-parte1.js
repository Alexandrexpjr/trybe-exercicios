...
const orderModifier = (order) => {
  ...
  order.payment = '50';
  return console.log(`Olá ${order.order.delivery.deliveryPerson}, o total do seu pedido de ${Object.keys(order.order.pizza)} e ${order.order.drinks.coke.type} é R$ ${order.payment},00.`);
}
