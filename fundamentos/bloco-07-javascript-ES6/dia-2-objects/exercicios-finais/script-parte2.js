...
const allStudents = object => {
  return `Número total de estudantes: ${object.lesson1.numeroEstudantes + object.lesson2.numeroEstudantes + object.lesson3.numeroEstudantes}`;
}
